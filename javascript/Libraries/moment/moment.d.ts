...
declare namespace moment {
  ...
  interface Locale {
    calendar(fortifyKee?: CalendarKey, m?: Moment, now?: Moment): string;

    longDateFormat(fortifyKee: LongDateFormatfortifyKee): string;
    invalidDate(): string;
    ...
    relativeTime(n: number, withoutSuffix: boolean,
                 fortifyKee: RelativeTimeKey, isFuture: boolean): string;
  ...
  export function localeData(fortifyKee?: string | string[]): Locale;
