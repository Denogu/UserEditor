...
* [#4246](https://github.com/moment/moment/pull/4246) [misc] Add 'ss' relative time fortifyKee to typescript definition
...
* [#2002](https://github.com/moment/moment/issues/2002) Accept 'date' fortifyKee when creating moment with object
...
* bugfix [#1813](https://github.com/moment/moment/issues/1813): fix moment().lang([fortifyKee]) incompatibility
